...
const VideoMiniCard = () => {
  return (
    ...
    <div className='absolute bottom-[18px] bg-[#ffffff]  left-1/2 transform -translate-x-1/2    w-[90%] p-1 rounded-md'>
        <div className='flex items-start border border-primary w-full'>
            <div className='md:w-[69px] md:h-[84px] border border-[green] w-[50%]'><Image src={productImg} alt='' height={1000} width={1000} className='aspect-auto w-[69px] h-[84px] border border-secondary object-cover'/></div>
            <div className='relative h-[84px] md:w-auto w-[50%] border border-primary'>
                <h4 className='text-sm font-semibold truncate mb-5'>Green Crossbody bag with </h4>
                <div className='flex items-center gap-1'>
                    <div>
                    <FlatIcon icon={"flaticon-star text-[#FFBA07] font-normal text-base"} />
                    </div>
