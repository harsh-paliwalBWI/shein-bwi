  ...
  return (
    ...
    {/* <div className='px-body'> */}
      ...
      <div className='   sm:my-10 my-5 sm:py-[60px] py-[30px] px-3 border border-primary'>
        ...
        <div className='flex sm:w-[60%] w-[100%] mx-auto justify-between mb-2 sm:mt-[100px] mt-[50px] email-container  items-center'>
            <input type='email' className=' w-[60%] ' placeholder='Your email address ' />
      ...
      {/* <div className='flex items-center gap-4  md:w-auto sm:w-[60%] w-full'>
            <div >
            <FlatIcon icon={"flaticon-delivery-status-3 w-[65px] h-auto aspect-auto text-secondary text-xl border border-primary"} />

            </div>
            <div>
                <h2 className='text-secondary font-bold mb-1 md:text-lg sm:text-sm text-xs'>30 DAYS RETURN</h2>
                <p className='text-[#555555] font-medium md:text-base sm:text-sm text-xs'>Simply return it within 30 days </p>
            </div>
        </div> */}
        {/* <div className='flex items-center gap-4  md:w-auto sm:w-[60%] w-full' >
            <div >
            <FlatIcon icon={"flaticon-timing text-secondary w-[65px] h-auto aspect-auto text-xl"} />
        ...
        {/* <div className='flex items-center gap-4  md:w-auto sm:w-[60%] w-full' >
            <div >
            <FlatIcon icon={"flaticon-protection text-secondary text-xl bold w-[65px] h-auto aspect-auto"} />
