...
const HowItWorks = () => {
  return (
    <div className='md:mb-20 mb-10 px-body  w-full'>
        ...
        <div className='flex md:flex-nowrap justify-center flex-wrap w-fit lg:gap-20  gap-5 md:justify-between mx-auto '>
          ...
          <h5 className='text-center  md:text-sm text-xs font-medium'>Select an outfit for your Friends and Family</h5>
            ...
            <div className='w-[198px]   flex flex-col items-center gap-y-4  '>
          <div className='h-[198px] flex flex-col gap-4  w-[198px]  '>
            <div className='flex w-full gap-4'><Image src={whatsAppImg} alt="" style={{width:"50%"}}/>
     ...
     <div className='flex flex-col gap-y-2 items-center'><h1 className='md:text-lg text-base   font-bold'>SHARE</h1>
